...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/04/06 18:19:53 by rrosaura          #+#    #+#              #
#    Updated: 2019/04/12 17:42:25 by rrosaura         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES = ft_strlen.c ft_strcmp.c ft_strncmp.c ft_strcpy.c ft_strncpy.c \
	   ...
	   ft_lstadd.c ft_lstiter.c ft_lstmap.c ft_findstart.c ft_findend.c \
	   ft_strtolower.c ft_strtoupper.c ft_swap.c

OBJ = ft_strlen.o ft_strcmp.o ft_strncmp.o ft_strcpy.o ft_strncpy.o \
	  ft_strcat.o ft_strncat.o ft_strlcat.o ft_strstr.o ft_strnstr.o \
	  ft_strchr.o ft_strrchr.o ft_isalpha.o ft_isdigit.o ft_isalnum.o \
	  ft_isascii.o ft_isprint.o ft_toupper.o \
	  ft_tolower.o ft_strdup.o ft_atoi.o ft_memset.o ft_bzero.o ft_memcpy.o \
	  ft_memccpy.o ft_memmove.o ft_memchr.o ft_memcmp.o ft_memalloc.o \
	  ...
	  ft_lstadd.o ft_lstiter.o ft_lstmap.o ft_findstart.o ft_findend.o \
	  ft_strtolower.o ft_strtoupper.o ft_swap.o
